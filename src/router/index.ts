...
import Litigasi from "../views/Litigasi2.vue";
import ClaimLitigasi from "../views/ClaimLitigasi.vue";
import ParcelLitigasi from "../views/ParcelLitigasi.vue";
...
import ClaimDetailLitigasi from "../views/ClaimDetailLitigasi.vue";
import LogLitigasi from "../views/LogLitigasi.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/land-litigasi/claim/",
      name: "claim-litigasi",
      component: ClaimLitigasi,
    },
    {
      path: "/land-litigasi/log/",
      name: "log-litigasi",
      component: LogLitigasi,
    },
    {
      path: "/land-litigasi/claim/:id",
      name: "claim-detail-litigasi",
      component: ClaimDetailLitigasi,
    },
    {
      path: "/land-litigasi/parcel/",
      name: "parcel-litigasi",
      component: ParcelLitigasi,
    },
    {
